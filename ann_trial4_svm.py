...
x = x + step * df_wrt_x  #subtracting instead of adding will be a negative "tug"
y = y + step * df_wrt_y
z = z + step * df_wrt_z
...
dsigmoid = sigmoid * (1 - sigmoid) #calculated derivative of sigmoid function

print sigmoid, dsigmoid
